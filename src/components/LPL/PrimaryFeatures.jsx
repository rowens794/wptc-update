      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            A Design Process Built for LPL Advisors
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            LPL advisors are different. You are different. I don't shove your
            practice into a standardized template that makes you look like
            everyone else. I help you create the story that communicates the
